...
class MY_Loader extends MX_Loader {
    ...
    function front_render_dashboard($template_name, $vars = array(), $page_script = '') {
     
        $this->view('dashboard_includes/dashboard_header', $vars);
        $this->view($template_name, $vars);
        
        $this->view('dashboard_includes/dashboard_footer', $vars);
        //$this->view('front_includes/common_script', $vars);
        if (!empty($page_script)):
            $this->view($page_script, $vars);
        endif;
